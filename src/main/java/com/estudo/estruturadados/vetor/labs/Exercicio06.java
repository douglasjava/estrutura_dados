...
public class Exercicio06 {
	...
	public static void opcao11(Lista<Contato> lista) {
		System.out.println("Vetor: " + lista);
	}

	public static void opcao10(Lista<Contato> lista) {
		lista.clear();
		System.err.println("Contatos removidos.");

	}

	public static void opcao09(Lista<Contato> lista) {

		System.out.println("Tamanho do vetor é: " + lista.tamanho());

	}

	public static void opcao08(Scanner scan, Lista<Contato> lista) {
	...
	public static void opcao07(Scanner scan, Lista<Contato> lista) {

		int posicao = lerInformacaoInt("Entre com a posição a ser removida.", scan);

		try {

			lista.removerElementoNaPosicao(posicao);
	...
	public static void opcao06(Scanner scan, Lista<Contato> lista) {
	...
	public static void opcao05(Scanner scan, Lista<Contato> lista) {
	...
	public static void opcao04(Scanner scan, Lista<Contato> lista) {
		...
		try {
			...
			posicao = lista.buscaPosicao(contato);
	...
	public static void opcao03(Scanner scan, Lista<Contato> lista) {
	...
	public static void opcao02(Scanner scan, Lista<Contato> lista) {
	...
	public static void opcao01(Scanner scan, Lista<Contato> lista) {
		...
		try {
			lista.adicionarElementoNaPosicao(posicao, contato);
